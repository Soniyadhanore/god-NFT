                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-6 col-md-6 col-sm-6 col-12'>
                                        <div className='loginright'>
                                            ...
                                            marginBottom: '10px' }}>{this.state.passwordMsg ? this.state.passwordMsg : ''}</div>:''    
                                            }
                                                ...
                                                <button type="submit" onClick={this.handleSubmit} disabled={!password || !password2 || this.state.passwordMsg || this.state.password2Valid} className="btn btn-primary login"><span><i className="fa fa-download" aria-hidden="true"></i></span>Reset Password</button>
